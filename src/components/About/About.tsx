...
const fallbackData: AboutData = {
  ...
  heading: "Welcome to AEIRC",
  paragraphs: [
    "Founded in 2023, Advance Education & Innovative Research Centre Pvt. Ltd. (AEIRC) is the first technology and innovation company in Nepal that is certified ISO 9001:2015",
  ...
  lead_text: "AEIRC leads in the fields of",
  features: [
...
const About = () => {
  const [data, setData] = useState<AboutData>(cachedAbout ?? fallbackData);

  useEffect(() => {
    if (cachedAbout) return;
    api
      .get<AboutData>("/about/info")
      .then((res) => {
        if (res.data) {
          cachedAbout = res.data;
          setData(res.data);
        }
      })
      .catch(() => {});
      ...
      <div className="container-xxl py-5">
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s" style={{ overflowWrap: "break-word", minWidth: 0 }}>
